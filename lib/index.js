  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('<script src="/assets/logo.js" type="text/javascript"></script>'),
        dom('<script src="/assets/ascii.js" type="text/javascript"></script>'),
        dom('<script src="/assets/matrix.js" type="text/javascript"></script>'),
        dom('<script src="/assets/index.js" type="text/javascript"></script>')
      ),
